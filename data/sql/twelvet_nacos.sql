...
INSERT INTO `config_info` VALUES (7, 'twelvet-server-job-dev.yml', 'DEFAULT_GROUP', '# Spring\nspring: \n  datasource:\n    dynamic:\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  \nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: 分布式调度服务\n  license: Powered By TwelveT\n  licenseUrl: https://www.twelvet.cn\n  terms-of-service-url: https://www.twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://www.twelvet.cn\n  authorization:\n    name: twelvet\n    auth-regex: ^.*$\n    authorization-scope-list:\n      - scope: server\n        description: server all\n    token-url-list:\n      - http://${GATEWAY_HOST:twelvet-gateway}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true', 'ef55b7db015f9dc19269b18e35cfd3bc', '2020-11-03 15:47:23', '2023-02-14 11:17:52', 'nacos', '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (8, 'twelvet-server-dfs-dev.yml', 'DEFAULT_GROUP', 'spring: \n  datasource:\n   dynamic:\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n\n##qiniu账户信息配置##\noss:\n  qiniu:\n    ## key\n    accessKey: accessKey\n    # 秘钥\n    secretKey: secretKey\n    # 储存桶\n    bucketName: twelvet\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: DFS服务\n  license: Powered By TwelveT\n  licenseUrl: https://www.twelvet.cn\n  terms-of-service-url: https://www.twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://www.twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true\n  ', 'c83eab4fc10a45b52c59438b72d89ca7', '2020-12-13 18:42:02', '2023-02-14 11:18:27', 'nacos', '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '分布式文件系统', 'null', 'null', 'yaml', 'null', '');
...
INSERT INTO `config_info` VALUES (25, 'twelvet-server-gen-dev.yml', 'DEFAULT_GROUP', '# spring配置\nspring: \n  datasource:\n    dynamic:\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  redis:\n    host: twelvet-redis\n    port: 6379\n    # 连接超时时间\n    timeout: 30s\n    lettuce:\n      pool:\n        # 连接池中的最小空闲连接\n        min-idle: 0\n        # 连接池中的最大空闲连接\n        max-idle: 8\n        # 连接池的最大数据库连接数\n        max-active: 8\n        # #连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-wait: -1ms\n\n# 代码生成\ngen: \n  # 作者\n  author: TwelveT\n  # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\n  packageName: com.twelvet.server.system\n  # 自动去除表前缀，默认是false\n  autoRemovePre: false\n  # 表前缀（生成类名不会包含表前缀，多个用逗号分隔）\n  tablePrefix: sys_\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: CRUD服务\n  license: Powered By TwelveT\n  licenseUrl: https://www.twelvet.cn\n  terms-of-service-url: https://www.twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://www.twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true', '17fce29e20785b502cdc9c228486c106', '2021-03-20 13:04:24', '2023-02-14 11:17:42', 'nacos', '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '代码生成器', 'null', 'null', 'yaml', 'null', '');
