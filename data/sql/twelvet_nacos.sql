...
INSERT INTO `config_info` VALUES (7, 'twelvet-server-job-dev.yml', 'DEFAULT_GROUP', '# Spring\nspring: \n  datasource:\n    dynamic:\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master \n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,wall,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet_job?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  \nswagger:\n  title: TwelveT Swagger API\n  version: 1.1.0\n  description: 分布式调度服务\n  license: Powered By TwelveT\n  licenseUrl: https://www.twelvet.cn\n  terms-of-service-url: https://www.twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://www.twelvet.cn\n  authorization:\n    name: twelvet\n    auth-regex: ^.*$\n    authorization-scope-list:\n      - scope: server\n        description: server all\n    token-url-list:\n      - http://${GATEWAY_HOST:twelvet-gateway}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true', '4200039d382339a0a5c9352264f8c8cf', '2020-11-03 15:47:23', '2022-03-02 14:07:19', 'nacos', '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (8, 'twelvet-server-dfs-dev.yml', 'DEFAULT_GROUP', 'spring: \n  datasource:\n   dynamic:\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master \n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,wall,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n\n##qiniu账户信息配置##\noss:\n  qiniu:\n    ## key\n    accessKey: accessKey\n    # 秘钥\n    secretKey: secretKey\n    # 储存桶\n    bucketName: twelvet\n\nswagger:\n  title: TwelveT Swagger API\n  version: 1.1.0\n  description: DFS服务\n  license: Powered By TwelveT\n  licenseUrl: https://www.twelvet.cn\n  terms-of-service-url: https://www.twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://www.twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true\n  ', '9e65b8e92a9629b9cd1808bd1b97b41e', '2020-12-13 18:42:02', '2022-06-24 08:29:42', '', '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '分布式文件系统', 'null', 'null', 'yaml', 'null', '');
...
INSERT INTO `config_info` VALUES (13, 'store.db.url', 'DEFAULT_GROUP', 'jdbc:mysql://rm-twelvet.mysql.rds.aliyuncs.com:3306/twelvet_seata?allowPublicKeyRetrieval=true&useUnicode=true', 'afaf8f99e8c60ca2837ae6e54ffbfb8e', '2021-03-10 14:55:41', '2021-03-10 14:59:51', NULL, '117.136.31.81', '', '60ca01e2-221e-47af-b7e5-64f2a7336973', 'null', 'null', 'null', 'null', 'null', '');
INSERT INTO `config_info` VALUES (14, 'store.db.user', 'DEFAULT_GROUP', 'twelvet', 'b08b1d0e53062cd03513b2fde5488e2f', '2021-03-10 14:55:42', '2021-03-10 14:59:21', NULL, '117.136.31.81', '', '60ca01e2-221e-47af-b7e5-64f2a7336973', 'null', 'null', 'null', 'null', 'null', '');
INSERT INTO `config_info` VALUES (15, 'store.db.password', 'DEFAULT_GROUP', 'liuxingmin', 'd3e297a95855225cc7cf5494c92b7f0b', '2021-03-10 14:55:42', '2021-03-10 14:57:53', NULL, '117.136.31.81', '', '60ca01e2-221e-47af-b7e5-64f2a7336973', 'null', 'null', 'null', 'null', 'null', '');
