...
(
    ...
    `create_by`   varchar(64) CHARACTER SET utf8 COLLATE utf8mb4_general_ci       NOT NULL COMMENT '创建者',
    `create_time` datetime                                                     NOT NULL COMMENT '创建时间',
    `update_by`   varchar(64) CHARACTER SET utf8 COLLATE utf8mb4_general_ci       NOT NULL COMMENT '更新者',
...
(
    ...
    `send_user_id`    varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL DEFAULT '0' COMMENT '消息发送人ID',
