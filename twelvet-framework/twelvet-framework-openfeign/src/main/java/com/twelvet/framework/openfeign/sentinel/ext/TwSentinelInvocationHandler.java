 ...
 * @author twelvet
 */
public class TwSentinelInvocationHandler implements InvocationHandler {

	private final static Logger log = LoggerFactory.getLogger(TwSentinelInvocationHandler.class);
	...
	TwSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			TwSentinelInvocationHandler other = (TwSentinelInvocationHandler) obj;
