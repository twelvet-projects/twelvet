 ...
 * @Description: 处理默认的密码模式认证
 */
public class TwDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public TwDaoAuthenticationProvider() {
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        if (clientAuthentication == null) {
            clientId = ServletUtils.getRequest().getParameter("clientId");
        } else {
