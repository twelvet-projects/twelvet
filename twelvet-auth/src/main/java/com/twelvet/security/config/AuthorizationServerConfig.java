...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
		...
		// 获取自定义授权模式
		List<TokenGranter> customTokenGranters = getTokenGranters(endpoints.getAuthorizationCodeServices(),
	...
	private List<TokenGranter> getTokenGranters(AuthorizationCodeServices authorizationCodeServices,
		...
		return new ArrayList<>(Arrays.asList(
				...
				new PhonePasswordTokenGranter(tokenServices, clientDetailsService, requestFactory,
						twTUserDetailsService)));
	}
